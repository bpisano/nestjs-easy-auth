...
> implements
    ToPublicModelConvertible<
      PublicSession<PublicModelOf<User>, PublicModelOf<Credentials>>
    >
{
  public constructor(
  ...
  public toPublicModel(): PublicSession<
    PublicModelOf<User>,
    PublicModelOf<Credentials>
  > {
    return new PublicSession(
      this.credentials.toPublicModel(),
      this.currentUser.toPublicModel()
    );
  }
}
