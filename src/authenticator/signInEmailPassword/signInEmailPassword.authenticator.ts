  ...
  implements Authenticator<SignInEmailPasswordInput, User>
{
  ...
  public readonly mapUser: (input: SignInEmailPasswordUserMapInput) => Partial<DatabaseModelOf<User>>;

  public constructor(params: { mapUser: (input: SignInEmailPasswordUserMapInput) => Partial<DatabaseModelOf<User>> }) {
