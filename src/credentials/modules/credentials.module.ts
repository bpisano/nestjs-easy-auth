...
export class CredentialsModule {
  public static withConfig<Credentials extends AnyCredentialsRepresentation>(params: {
    storage: Type<CredentialsStorage<Credentials>>;
    jwtConfig: JWTConfig;
  }): DynamicModule {
    return {
      module: CredentialsModule,
      imports: [JWTModule.withConfig(params.jwtConfig), CredentialsStorageModule.usingStorage(params.storage)],
      providers: [{ provide: CREDENTIALS_SERVICE, useClass: ApiCredentialsService }],
      exports: [CREDENTIALS_SERVICE]
    };
  }

  public static mongo(params: { config: MongoConfig; jwtConfig: JWTConfig }): DynamicModule {
    return {
      module: CredentialsModule,
      imports: [JWTModule.withConfig(params.jwtConfig), CredentialsStorageModule.mongo({ config: params.config })],
      providers: [{ provide: CREDENTIALS_SERVICE, useClass: ApiCredentialsService }],
      exports: [CREDENTIALS_SERVICE]
    };
  }
