...
export interface CredentialsStorage<Credentials extends AnyCredentialsRepresentation> {
  ...
  create(credentials: Partial<DatabaseModelOf<Credentials>>): Promise<DatabaseModelOf<Credentials>>;
